...
const fishing = {
  ...
  tourPage: {
    ...
    paragraph1: "Join us on our exhilarating 4-hour Deep Sea Fishing Tour in Sosua, where the open waters  become your playground for an unforgettable fishing experience. Step aboard our well-equipped fishing vessel, manned by experienced captains and crew who are passionate about fishing. Leave the shores behind as we venture into the deep blue, where big game fish roam. Feel the adrenaline surge through your veins as you cast your line and wait for that exhilarating bite.",
    title2: "Abundance of Marine Life",
    paragraph2: "Sosua is renowned for its rich marine biodiversity, making it a prime destination for deep sea fishing enthusiasts. Prepare to encounter an array of impressive species, including marlin, sailfish, dorado, wahoo, and tuna. Our experienced crew will share their knowledge and techniques to increase your chances of landing that trophy fish. As you venture further into the open sea, immerse yourself in the breathtaking coastal scenery of Sosua. Admire the rugged cliffs, golden beaches, and crystal-clear waters that surround this stunning destination. Capture stunning photographs and soak in the natural beauty.",
