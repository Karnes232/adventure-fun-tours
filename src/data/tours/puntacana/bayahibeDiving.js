...
const bayahibeDiving = {
  ...
  cost: "",
  description:
    "Dive into crystal-clear waters, explore vibrant coral reefs, and encounter an abundance of marine life in one of the Dominican Republic's most renowned diving destinations.",
  tourPage: {
